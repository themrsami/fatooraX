...
export function TestimonialSlider() {
  ...
  return (
    <div className="relative max-w-3xl mx-auto ">
      <div className="absolute -top-10 -left-4 text-zinc-800/50">
      ...
      <div className="relative z-10 min-h-[300px] flex items-center">
        <div className="w-full">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <blockquote className="text-lg md:text-xl font-serif italic mb-8 text-center px-4">
                "{testimonial.content}"
              </blockquote>
              <div className="flex flex-col items-center">
                <div className="h-12 w-12 rounded-full bg-zinc-800 flex items-center justify-center mb-3 border border-zinc-700">
        ...
        {testimonials.map((_, index) => (
          <button
            ...
            className={cn(
              ...
              index === activeIndex ? "bg-white w-8" : "bg-zinc-700 w-2 hover:bg-zinc-600",
            )}
